...
data_features %>% 
  ...
  geom_violin(mapping = aes(x = ratio_race_podiums_driver, y = race_position),
              draw_quantiles = c(0.25, 0.5, 0.75)) +
  labs(x = "Podiums Achieved %age Driver", y = "Race Position") +
  theme_vaw_light()
...
# Mean DNFs Driver -----------------------------------------------------------
data_features %>% 
  mutate(dnf_mean_driver_circuit = cut_interval(x = dnf_mean_driver_circuit, length = 0.1)) %>% 
  ggplot() +
  geom_violin(mapping = aes(x = dnf_mean_driver_circuit, y = race_position),
              draw_quantiles = c(0.25, 0.5, 0.75), scale = "width") +
  labs(x = "DNF %age Driver Circuit", y = "Race Position") +
  theme_vaw_light()
...
# Count DNF Last 5 Driver ---------------------------------------------------
data_features %>% 
  mutate(dnf_l5_driver_circuit = factor(round(dnf_l5_driver_circuit), levels = 1:5)) %>% 
  ggplot() +
  geom_violin(mapping = aes(x = dnf_l5_driver_circuit, y = race_position),
              draw_quantiles = c(0.25, 0.5, 0.75), scale = "width") +
  labs(x = "DNFs L5 Driver Circuit", y = "Race Position") +
  theme_vaw_light()
